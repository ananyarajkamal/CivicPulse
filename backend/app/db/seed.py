...
CATEGORIES_DATA = [
    # Roads
    {
        ...
        "sla": 24,
        "keywords": ["pothole", "hole", "crater", "asphalt"],
    },
    {
        "dept_code": "ROADS",
        ...
        "sla": 72,
        "keywords": ["sidewalk", "pavement", "curb", "walkway"],
    },
    {
        "dept_code": "ROADS",
        ...
        "priority": ComplaintPriority.MEDIUM,
        "sla": 48,
        "keywords": ["sign", "stop sign", "traffic sign", "street sign"],
    },
    {
        "dept_code": "ROADS",
        "name": "Speed Bump Issue",
        "priority": ComplaintPriority.LOW,
        "sla": 96,
        "keywords": ["speed bump", "hump", "traffic calming"],
    },
    # Water
    {
        "dept_code": "WATER",
        ...
        "sla": 12,
        "keywords": ["water leak", "pipe burst", "gushing water", "leak"],
    },
    {
        "dept_code": "WATER",
        ...
        "priority": ComplaintPriority.CRITICAL,
        "sla": 12,
        "keywords": ["sewage", "sewer", "drain overflow", "foul smell"],
    },
    {
        "dept_code": "WATER",
        ...
        "priority": ComplaintPriority.HIGH,
        "sla": 24,
        "keywords": ["no water", "dry tap", "water cut"],
    },
    {
        "dept_code": "WATER",
        "name": "Discolored Water",
        "priority": ComplaintPriority.HIGH,
        "sla": 24,
        "keywords": ["brown water", "dirty water", "tap water"],
    },
    # Waste
    {
        "dept_code": "WASTE",
        ...
        "priority": ComplaintPriority.MEDIUM,
        "sla": 24,
        "keywords": ["missed pickup", "garbage", "trash bin", "refuse"],
    },
    {
        "dept_code": "WASTE",
        ...
        "priority": ComplaintPriority.HIGH,
        "sla": 24,
        "keywords": ["dumping", "debris", "fly tipping", "junk"],
    },
    {
        "dept_code": "WASTE",
        ...
        "priority": ComplaintPriority.MEDIUM,
        "sla": 24,
        "keywords": ["public bin", "overflowing", "litter bin"],
    },
    {
        "dept_code": "WASTE",
        ...
        "priority": ComplaintPriority.HIGH,
        "sla": 12,
        "keywords": ["dead animal", "carcass", "roadkill"],
    },
    # Lighting
    {
        "dept_code": "LIGHTING",
        ...
        "priority": ComplaintPriority.MEDIUM,
        "sla": 36,
        "keywords": ["streetlight", "lamp", "dark street", "light out"],
    },
    {
        "dept_code": "LIGHTING",
        "name": "Exposed Wiring",
        "priority": ComplaintPriority.CRITICAL,
        "sla": 12,
        "keywords": ["wire", "exposed wiring", "electric hazard", "sparks"],
    },
    {
        "dept_code": "LIGHTING",
        ...
        "priority": ComplaintPriority.LOW,
        "sla": 72,
        "keywords": ["flickering", "blinking light"],
    },
    # Parks
    {
        "dept_code": "PARKS",
        ...
        "priority": ComplaintPriority.HIGH,
        "sla": 24,
        "keywords": ["tree", "branch", "fallen tree", "blocking road"],
    },
    {
        "dept_code": "PARKS",
        "name": "Damaged Playground Equipment",
        "priority": ComplaintPriority.HIGH,
        "sla": 48,
        "keywords": ["playground", "swing", "slide", "broken park"],
    },
    {
        "dept_code": "PARKS",
        ...
        "priority": ComplaintPriority.LOW,
        "sla": 96,
        "keywords": ["grass", "weeds", "bushes", "overgrown"],
    },
    # Safety
    {
        "dept_code": "SAFETY",
        "name": "Stray Animal Hazard",
        "priority": ComplaintPriority.MEDIUM,
        "sla": 24,
        "keywords": ["stray dog", "animal control", "bites"],
    },
    {
        "dept_code": "SAFETY",
        "name": "Public Nuisance / Noise",
        "priority": ComplaintPriority.LOW,
        "sla": 48,
        "keywords": ["noise", "loud music", "nuisance"],
    },
    {
        "dept_code": "SAFETY",
        "name": "Hazardous Building / Wall",
        "priority": ComplaintPriority.HIGH,
        "sla": 24,
        "keywords": ["wall collapse", "structural hazard", "dangerous building"],
    },
    # Environment
    {
        "dept_code": "ENV",
        ...
        "priority": ComplaintPriority.HIGH,
        "sla": 24,
        "keywords": ["drain", "storm drain", "flooding", "clogged drain"],
    },
    {
        "dept_code": "ENV",
        "name": "Air Pollution / Burning",
        "priority": ComplaintPriority.MEDIUM,
        "sla": 48,
        "keywords": ["smoke", "burning", "air quality", "chemical smell"],
    },
    {
        "dept_code": "ENV",
        ...
        "priority": ComplaintPriority.HIGH,
        "sla": 24,
        "keywords": ["river pollution", "chemical waste", "stream"],
    },
    {
        "dept_code": "ENV",
...
async def seed_database(db: AsyncSession) -> dict[str, int]:
    ...
    for d_data in DEPARTMENTS_DATA:
        ...
        res = await db.execute(select(Department).where(Department.code == code_str))
    ...
    for c_data in CATEGORIES_DATA:
        ...
        if not res_cat.scalar_one_or_none():
            cat = ComplaintCategory(
                ...
                default_priority=c_data["priority"].value
                if hasattr(c_data["priority"], "value")
                else str(c_data["priority"]).lower(),
